        ...
        <Row label="Vim" hint="Включён по умолчанию — это одна из трёх причин, по которым приложение существует">
          <div className="stack">
            ...
            <span className="card__note">
              ...
              отдельно и уносят с собой смену колонок на <code>⌃⇧H</code> и <code>⌃⇧L</code>
              вместе с индикатором в титульной строке: он существует ради переключения вслепую.
              Фокус всё равно переезжает — <code>⏎</code> в текст, <code>esc</code> обратно,
              щелчок по колонке. Стрелки в списке и остальные команды работают в любом случае.
